...
lv_obj_t * ui_RoomHumidTitle1;
lv_obj_t * ui_RoomHumidData1;
lv_obj_t * ui_FanIcon;
lv_obj_t * ui_FanIMG;
...
void ui_Screen1_screen_init(void)
{
    ...
    ui_HomeTitle = lv_label_create(ui_AppBar);
    ...
    lv_label_set_text(ui_HomeTitle, "Sensor Monitor");
    lv_obj_set_style_text_font(ui_HomeTitle, &lv_font_montserrat_24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_TempData2 = lv_label_create(ui_Soil_TempGroup);
    lv_obj_set_width(ui_TempData2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_TempData2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_TempData2, 0);
    lv_obj_set_y(ui_TempData2, 20);
    lv_obj_set_align(ui_TempData2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_TempData2, "34.55");
    lv_obj_set_style_text_font(ui_TempData2, &lv_font_montserrat_48, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_RoomHumidTitle1 = lv_label_create(ui_fertility_Group);
    lv_obj_set_width(ui_RoomHumidTitle1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_RoomHumidTitle1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_RoomHumidTitle1, 0);
    lv_obj_set_y(ui_RoomHumidTitle1, -10);
    lv_obj_set_align(ui_RoomHumidTitle1, LV_ALIGN_TOP_MID);
    lv_label_set_text(ui_RoomHumidTitle1, "Fertility");
    lv_obj_set_style_text_font(ui_RoomHumidTitle1, &lv_font_montserrat_26, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_RoomHumidData1 = lv_label_create(ui_fertility_Group);
    lv_obj_set_width(ui_RoomHumidData1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_RoomHumidData1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_RoomHumidData1, 0);
    lv_obj_set_y(ui_RoomHumidData1, 20);
    lv_obj_set_align(ui_RoomHumidData1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_RoomHumidData1, "78");
    lv_obj_set_style_text_font(ui_RoomHumidData1, &lv_font_montserrat_48, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_FanIcon = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_FanIcon, 229);
    lv_obj_set_height(ui_FanIcon, 95);
    lv_obj_set_x(ui_FanIcon, 30);
    lv_obj_set_y(ui_FanIcon, -25);
    lv_obj_set_align(ui_FanIcon, LV_ALIGN_BOTTOM_LEFT);
    ...
    ui_LightIcon = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_LightIcon, 229);
    lv_obj_set_height(ui_LightIcon, 95);
    lv_obj_set_x(ui_LightIcon, 0);
    lv_obj_set_y(ui_LightIcon, -25);
    lv_obj_set_align(ui_LightIcon, LV_ALIGN_BOTTOM_MID);
    ...
    ui_WateringIcon = lv_obj_create(ui_Screen1);
    lv_obj_set_width(ui_WateringIcon, 229);
    lv_obj_set_height(ui_WateringIcon, 95);
    lv_obj_set_x(ui_WateringIcon, -30);
    lv_obj_set_y(ui_WateringIcon, -25);
    lv_obj_set_align(ui_WateringIcon, LV_ALIGN_BOTTOM_RIGHT);
